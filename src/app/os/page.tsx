...
export const metadata: Metadata = {
  ...
  description:
    "Интерактивная OS-среда с профилем, навыками и кейсами Артема Козыренко. Senior Business Analyst: Purrweb, Т-Банк. Финтех, AI/ML, SaaS.",
  alternates: {
  ...
  twitter: {
    ...
    title: "ARTI.OS — Интерактивное резюме Артема Козыренко",
    description: "Интерактивная OS-среда. Senior BA: Purrweb, Т-Банк. Финтех, AI/ML, SaaS.",
